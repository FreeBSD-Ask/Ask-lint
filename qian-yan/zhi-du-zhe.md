...
以上种种对语言的探索启发我们不能简单地将上面发生情况的当事人视为负面的存在而放弃了教育的可能性。而应该反思自己的教学方式。孔子面对不同的学生强调因材施教。我们的确有更完善的、无歧义的表达方式进行说明，问题在于我们往往已经预设了你的读者和你之间存在一种相同的前理解和前意识。因此随着讨论的深入，你们的分歧只会越来越多。
